...
|--------|-----|---|
| 🏨 [Healthcare Data Analysis Project-1](https://github.com/eda-aty/healthcare-analytics-tableau-project) | Data analysis | This is a healthcare data analysis case study using PostgreSQL. It demonstrates my ability to solve real-world hospital business problems with SQL, focusing on patient demographics, diagnosis burden, treatment effectiveness, healthcare costs, and seasonal trends. | 
...
|---|---|---|
|  🏨 [Healthcare Analytics – Treatment Effectiveness & Cost Efficiency](https://public.tableau.com/views/HealtcareTableauProject/ExecutiveOverview?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) | Visualised key insights using Tableau, including some kpı’s and sales . | - 🔗 [View Dashboard on Tableau Public](https://public.tableau.com/views/HealtcareTableauProject/ExecutiveOverview?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) |
