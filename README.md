...
| Project Link | Project Description | Dashboard Link |
|---|---|---|
|☕️ [Coffeeshop Analysis &Insights] (https://datastudio.google.com/s/pO6MY_fCq8c)| This project analyzes the sales transactions from a coffee shop, stored in the Transactions table.
