...
| 🧬🩺 [tableau-healthcare-project] (https://github.com/eda-aty/tableau-healthcare-project))| This project analyzes patient appointment attendance patterns to identify factors that contribute to no-shows. | [pandas, matplotlib, seaborn](https://public.tableau.com/views/HealtcareDataAnalysisProject/Dashboard1?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link) |
